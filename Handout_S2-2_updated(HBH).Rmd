...
# 
Hmisc::describe(mydata)               #factor 인것 아닌것
...
# Metadata of the imported data   #속성
attributes(mydata)   
```
...
moonBook::densityplot(t_test.value ~ group,data=mydata)
...
ggcorrplot::cor_pmat(mydata[,2:12])
